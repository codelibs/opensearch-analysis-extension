...
OpenSearch Analysis Extension Plugin provides Tokenizer/CharFilter/TokenFilter.
...
Please file an [issue](https://github.com/codelibs/opensearch-analysis-extension/issues "issue").
